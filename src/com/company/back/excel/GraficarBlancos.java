...
public class GraficarBlancos {
    ...
    public GraficarBlancos(ArrayList objects) {
        ...
        try {
            for (int i = 0; i < getObjects().size(); i++) {
                ...
                for (int j = 0; j < unidad.getNombre().size(); j++) {
                    ...
                    MS2525c.putTextModifier(ILcdMS2525bCoded.sEffectiveTime, unidad.getFechaEfectiva().get(j).toString());
    ...
    public String caracteresSimbolo(LeerCamposDesdeExcelParaGraficacion unidad, int i) {
        ...
        String CAMPO5_6_7 =tipoBlancoParaGraficar(unidad.getTipoBlanco().get(i).toString());
        String CAMPO8 = "-";
        String CAMPO9 = "-";
        String CAMPO10 = "-";
        String CAMPO11 = "-";
        ...
        String ORDENBATALLA15 = "X";
        return CAMPO1 + FILIACION2 + CAMPO3 + ESTADO4 + CAMPO5_6_7 + CAMPO8 + CAMPO9 + CAMPO10 +
                CAMPO11 + ESCALON12 + PAIS13_14 + ORDENBATALLA15;


    }

    public String tipoBlancoParaGraficar(String blanco) {
        switch (blanco) {
            case "BLANCO UNICO":
                return "PTS";
            case "BLANCO LINEAR":
                return "LT-";
            case "BLANCO RECTANGULAR":
                return "ATR";
            case "BLANCO CIRCULAR":
                return "ATC";
            case "GRUPO BLANCOS":
                return "ATG";
            default:
