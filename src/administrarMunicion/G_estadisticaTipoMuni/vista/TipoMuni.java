 ...
 */
package administrarMunicion.G_estadisticaTipoMuni.vista;
...
public class TipoMuni extends JFrame {
    ...
    public TipoMuni() {
        ...
        for (int i = 0; i < AlmacenMuni.getArrayList().size(); i++) {
            ...
            model.addRow(municion.tipoMuni());
        }

        // Creando el Grafico
        JFreeChart chart = ChartFactory.createPieChart3D("ESTADISTICA MUNICIÓN", defaultpiedataset, true, true, false);
    ...
    private void initComponents() {
        ...
        jtRegistros = new Jtable(TituloTabla.Nuevo_registro2, new Object[0][0]);
